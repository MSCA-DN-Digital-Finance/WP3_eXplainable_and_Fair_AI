...
from factories import make_alloc_task_factory
...
gens = [LinearTrendGenerator(slope=0.0), LinearTrendGenerator(slope=ref_param)]
...
build_all_alloc = make_alloc_task_factory(
