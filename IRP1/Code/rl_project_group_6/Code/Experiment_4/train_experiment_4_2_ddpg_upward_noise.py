...
from generators import NoisyTrendPriceGenerator, CashPriceGenerator
...
generators = {
"UPWARD": NoisyTrendPriceGenerator(mean=0.001, variance=0.02),  #
...
image_path = os.path.join(folder_path, "4_2_upward_noise.png")
...
e_train_gym.save_episode_log("Results/Experiment_4/training_logs_4_2_ddpg_upward_noise.csv")

experiments_settings = "4_2_ddpg_upward_noise"
